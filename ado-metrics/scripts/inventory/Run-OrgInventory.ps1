...
$markdownLines += "| ⚙️ Total Pipelines | $($metrics.TotalPipelines) |"
$markdownLines += "| ☁️ Microsoft-Hosted Pipelines | $($metrics.MicrosoftHostedPipelines) |"
$markdownLines += "| 🖥️ Self-Hosted Pipelines | $($metrics.SelfHostedPipelines) |"
...
$markdownLines += "|--------------|-------|------------|"
$markdownLines += "| ☁️ Microsoft-Hosted | $($metrics.MicrosoftHostedPipelines) | ${msHostedPct}% |"
$markdownLines += "| 🖥️ Self-Hosted | $($metrics.SelfHostedPipelines) | ${selfHostedPct}% |"
